							  ...
							  <input type="hidden" name="updateid" id="updateid" value="{{$updateid}}"> 
								...
								<div class="form-group">
									<div class="row">
										...
										<?php if($logo!=''){ ?>
											<div class="col-sm-5 col-md-5 col-xs-5" id="storelogo" style="display:block">
								...
								<div class="row">
									  <div class="col-sm-12">
									  <label for="inputPassword3">Post Code</label>
									  <label for="">
									  <input type="text" id="post_code" class="form-control" maxlength="10" name="post_code" onkeypress="return isNumberKey(event)" value="{{$postcode}}">
									  </label>
								...
								<div class="col-sm-6 col-md-6 col-xs-12">
									...
									<label for="">
										<input type="text" id="service" name="service"  value="{{$service}}" class="form-control">
									</label>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											...
											<label for="">
												<textarea id="about_merchant" name="about_merchant" class="form-control"><?php echo $aboutmerchant; ?></textarea>
											</label>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											...
											<label for="">
												<textarea id="termsconditiondesp" name="termsconditiondesp" class="form-control"><?php echo $termscondt; ?></textarea>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											<label for="">
												<button type="submit" class="hvr-sweep-to-right">{{$button_text}}</button>
											</label>
										</div>
									</div>	
								</div>

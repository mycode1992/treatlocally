...
<section class="content-header">
 ...
 <div class="col-xs-3" style="margin: 20px 0 10px;">
    ...
    <a href="{{url('/cms/add-sub-category')}}">
        
        <button type="button" class="btn btn-block btn-warning btn-flat pull-right" style="background: #222d32;font-weight: 700;border-color: #222d32;">Add Sub-Category</button>
    </a>
          ...
          @foreach($relation AS $rel_val)
             ...
             ?>
                 <tr id="deleterow<?php echo $rel_val->id;?>">
                  ...
                  <td>{{ $rel_val->name }}</td>
                  <td>
                    <a href="{{url('/cms/add-sub-category'.'/'.$rel_val->id)}}">

...
<?php
  ...
  if( $segment!=''){
    ...
    $tl_userdetail_postcode = $data[0]['tl_userdetail_postcode'];
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                     ...
                     <input type="text" class="form-control" id="phoneno"  maxlength="15" onkeypress="return isNumberKey(event)" name="phoneno" value="{{$phn}}">                    
                  </div>
                 ...
                 <div class="col-sm-4">
                  <label for="inputPassword3" class="tl-about-smallheading">Post code</label>
                 <input type="text" class="form-control" id="post_code" maxlength="25"  name="post_code" value="{{$tl_userdetail_postcode}}">                    
                 </div>
   ...
   //return false;
    ...
    success:function(response) 
    {
      ...
      else if(response=='3')
      {
        document.getElementById("errormsg").style.color = "#278428";
        // document.getElementById("errormsg").style.color = "#ff0000";
         document.getElementById("errormsg").innerHTML='Merchant info updated successfully' ;
